...
class __TwigTemplate_d027c89b5016e84fb8956f3f4ea9a6ab extends Template
{
    private $source;
    private $macros = [];
...
\t\t<div class=\"col-12 col-md-6 bg-white p-4 m-0 titre\">
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 12, $this->source); })()), "flashes", ["verify_email_error"], "method", false, false, false, 12));
...
";
    ...
    {
        return array (  144 => 30,  138 => 27,  131 => 23,  128 => 22,  126 => 20,  122 => 19,  118 => 18,  114 => 17,  110 => 15,  101 => 13,  97 => 12,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
             ...
             {% endfor %}
              ...
              {{ form_start(registrationForm) }}
                  ...
                  {{ form_row(registrationForm.plainPassword, {
                   ...
                   {{ form_row(registrationForm.agreeTerms, {label: 'Acceptez les conditions dutilisations'}) }}
...
{% endblock %}
", "registration/register.html.twig", "/var/www/html/Minerva3/templates/registration/register.html.twig");
    }
}
